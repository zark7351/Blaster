...
FVector AWeapon::TranceEndWithScatter(const FVector& HitTarget)
{
...
void AWeapon::OnEquipped()
{
	...
	{
		BlasterOwnerController = BlasterOwnerController == nullptr ? Cast<ABlasterPlayerController>(BlasterOwnerCharacter->Controller) : BlasterOwnerController;
		if (BlasterOwnerController && HasAuthority() && !BlasterOwnerController->HighPingDeleget.IsBound())
		{
			BlasterOwnerController->HighPingDeleget.AddDynamic(this, &AWeapon::OnPingTooHigh);
		}
	}
}
...
void AWeapon::OnDropped()
{
	...
	if (BlasterOwnerCharacter && bUseServerSideRewind)
	{
		...
		if (BlasterOwnerController && HasAuthority() && BlasterOwnerController->HighPingDeleget.IsBound())
		{
			BlasterOwnerController->HighPingDeleget.RemoveDynamic(this, &AWeapon::OnPingTooHigh);
		}
	}
}
